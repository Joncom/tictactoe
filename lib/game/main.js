    ...
    MyGame = ig.Game.extend({
        ...
        draw: function() {
            ...
            */
            ...
            var glowX = ( ig.system.width / 2 ) - ( this.glow.width / 2 );

            var glowY = ( ig.system.height / 2 ) - ( this.glow.height / 2 );

            ig.system.context.globalAlpha = Math.abs( Math.sin( this.timer.delta() ) );

            this.glow.draw( glowX, glowY );
