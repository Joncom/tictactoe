                ...
                for( var y = 0; y < this.n; y++ ) {
                    ...
                    if( typeof marker.player === 'undefined' ) {
                        ...
                        if( x == block.pos.x && y == block.pos.y
                            ...
                            // Do effect.
                            marker.currentAnim = marker.anims[ this.nextTurn + '-hover' ];
                    ...
                    if( typeof this.markers[ block.pos.x ][ block.pos.y ].player === 'undefined' ) {
                        ...
                        // Check for win.
                            ...
                            for( i = 0; i < this.n; i++ ) {
                                ...
                                if( this.markers[ block.pos.x ][ i ].player != this.nextTurn ) {
                            ...
                            for( i = 0; i < this.n; i++ ) {
                                ...
                                if( this.markers[ i ][ block.pos.y ].player != this.nextTurn ) {
