                    ...
                    if( blockX >= 0 && blockX < this.columns
                        ...
                        // Check for win.
                            ...
                            for( i = 0; i < this.columns; i++ ) {
                                ...
                                if( this.markers[ blockX ][ i ].team != this.nextTurn ) {
                            ...
                            for( i = 0; i < this.rows; i++ ) {
                                ...
                                if( this.markers[ i ][ blockY ].team != this.nextTurn ) {
                            ...
                            if( blockX == blockY ) {
                                ...
                                for( i = 0; i < this.rows; i++ ) {
                                    ...
                                    if( this.markers[ i ][ i ].team != this.nextTurn ) {
                            ...
                            for( i = 0; i < this.rows; i++ ) {
                                ...
                                if( typeof this.markers[ i ][ ( this.rows - 1 ) - i ] === 'undefined' ) {

                                    break;

                                }

                                if( this.markers[ i ][ ( this.rows - 1 ) - i ].team != this.nextTurn ) {
