...
.defines(function() {
    ...
    EntityGrid = ig.Entity.extend({
        ...
        init: function(x, y, settings) {
            ...
            this.rowMarkerCount.x = new Array();

            this.rowMarkerCount.o = new Array();

            for( y = 0; y < this.rows; y++ ) {

                this.rowMarkerCount.x[ y ] = 0;

                this.rowMarkerCount.o[ y ] = 0;
            ...
            if( ig.input.pressed( 'mouse1' ) ) {
                ...
                if( typeof this.markers[ blockX ][ blockY ] === 'undefined' ) {
                    ...
                    if( blockX >= 0 && blockX < this.columns
                        ...
                        // Increase counter used to determine winner.
                        this.rowMarkerCount[ this.nextTurn ][ blockY ]++;
                        ...
                        // Check for winner.
                        if( this.rowMarkerCount[ this.nextTurn ][ blockY ] >= 3 ) {
