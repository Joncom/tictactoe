                    ...
                    if( typeof this.markers[ block.pos.x ][ block.pos.y ].player === 'undefined' ) {
                        ...
                        // Check for win.
                            ...
                            for( i = 0; i < this.n; i++ ) {
                                ...
                                if( typeof this.markers[ block.pos.x ][ i ] === 'undefined' ) {

                                    break;

                                }

                                if( this.markers[ block.pos.x ][ i ].player != this.turn ) {
                            ...
                            for( i = 0; i < this.n; i++ ) {
                                ...
                                if( typeof this.markers[ i ][ block.pos.y ] === 'undefined' ) {

                                    break;

                                }

                                if( this.markers[ i ][ block.pos.y ].player != this.turn ) {
                            ...
                            if( block.pos.x == block.pos.y ) {
                                ...
                                for( i = 0; i < this.n; i++ ) {
                                    ...
                                    if( this.markers[ i ][ i ].player != this.turn ) {
                            ...
                            for( i = 0; i < this.n; i++ ) {
                                ...
                                if( this.markers[ i ][ ( this.n - 1 ) - i ].player != this.turn ) {
